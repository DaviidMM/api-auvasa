...
const gtfsGetBusOccupancy = async (tripId) => {
  try {
    ...
    try {
      ...
      return occupancyStatusMapping[occupancyStatus];
    } catch (error) {
      console.error('Error al decodificar el feed GTFS Realtime:', error);
      return null; // Devolver null en caso de error de decodificación
    }
  } catch (error) {
    console.error(
    ...
    return null; // Devolver null en caso de otro error
  }
};
